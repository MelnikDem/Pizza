...
poligon.addEventListener('dragover', preventEvent);
home.addEventListener('dragover', preventEvent);

function preventEvent(e){
	e.preventDefault();
}

poligon.addEventListener('drop', dropElement);
home.addEventListener('drop', dropElement);
